              ...
              children: [
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    ...
                    // Check if the mobile number starts with +8801 or 01 and has a length of 11
                    if (!RegExp(r'^(\+8801|01)\d{9}$').hasMatch(value!)) {
                ...
                TextFormField(
                  ...
                  validator: (value) {
                    // Shipping address can be empty, so no validation required.
                    return null;
                  },
                ),
                const SizedBox(
